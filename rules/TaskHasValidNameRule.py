...
load look make move notify own parse perform play put read refresh reload
remove reown retrieve restart run set show start stop take talk tell test try
turn update use validate verify wait work\
""".split()
